...
suite('Unit Tests', () => {
  ...
  suite('Highlight translated terms', () => {
    test('Highlight translation in Mangoes are my favorite fruit.', () => {
      const out = translator.translateWithHighlight(
        'Mangoes are my favorite fruit.',
        'american-to-british'
      );
      assert.include(out, '<span class="highlight">favourite</span>');
    });
    ...
    test('Highlight translation in I ate yogurt for breakfast.', () => {
      ...
      assert.include(out, '<span class="highlight">yoghurt</span>');
    });
    ...
    test('Highlight translation in We watched the footie match for a while.', () => {
      ...
      assert.include(out, '<span class="highlight">soccer</span>');
    });
    ...
    test('Highlight translation in Paracetamol takes up to an hour to work.', () => {
      ...
      assert.include(out, '<span class="highlight">Tylenol</span>');
    });
  });
});
